...
class SiswaController extends Controller
{
    ...
    public function store()
    {
        ...
        // 2. Validasi Simple
        if (in_array("", $data)) {
            $this->redirect("siswa/create")->with(
                "error",
    ...
    public function update()
    {
        ...
        // 4. Validasi Simple
        if (in_array("", $data)) {
            $this->redirect("siswa/edit?id=" . $id)->with(
                "error",
    ...
    public function destroy()
    {
        ...
        $this->redirect("siswa")->with(
            "success",
            "Data Siswa & Akun Login berhasil dihapus!"
        );
    }
}

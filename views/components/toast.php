...
<div class="myToast-container">
    <div class="myToast myToast-success">
        ...
        <div class="myToast-content">
            ...
            <span class="myToast-message">Data berhasil disimpan ke database.</span>
        </div>
    ...
    <div class="myToast myToast-info">
        ...
        <div class="myToast-content">
            ...
            <span class="myToast-message">Jadwal maintenance pukul 23:00 WIB.</span>
        </div>
        <div class="myToast-close" onclick="closeMyToast(this)">&times;</div>
    </div>
    ...
    <div class="myToast myToast-warning">
        ...
        <div class="myToast-content">
            ...
            <span class="myToast-message">Sisa penyimpanan Anda tinggal 10%.</span>
        </div>
        <div class="myToast-close" onclick="closeMyToast(this)">&times;</div>
    </div>
    ...
    <div class="myToast myToast-error">
        ...
        <div class="myToast-content">
            ...
            <span class="myToast-message">Gagal terhubung ke server (500).</span>
        </div>
        <div class="myToast-close" onclick="closeMyToast(this)">&times;</div>
    </div>
    ...
    <div class="myToast myToast-question">
        ...
        <div class="myToast-content">
            ...
            <span class="myToast-message">Simpan perubahan ini?</span>
            <div class="myToast-actions">
                <button class="btn-confirm" onclick="closeMyToast(this)">Ya, Simpan</button>
                <button class="btn-cancel" onclick="closeMyToast(this)">Lupakan</button>
            </div>
        </div>
        <div class="myToast-close" onclick="closeMyToast(this)">&times;</div>
    </div>

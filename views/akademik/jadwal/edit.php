            ...
            <div class="col-md-8">
                <div class="card card-warning">
                    ...
                    <form action="<?php echo BASE_URL; ?>/jadwal/update" method="POST">
                        <input type="hidden" name="jadwal_id" value="<?php echo $data[
                            "jadwal"
                        ]["jadwal_id"]; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="kelas_id" name="kelas_id" required>
                                            ...
                                            <?php foreach (
                                                ...
                                                <option value="<?php echo $kls[
                                                    "kelas_id"
                                                ]; ?>" <?php echo $kls[
    "kelas_id"
] == $data["jadwal"]["kelas_id"]
    ? "selected"
    : ""; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="hari" name="hari" required>
                                            ...
                                            <?php foreach (
                                                ...
                                                <option value="<?php echo $hr; ?>" <?php echo $hr ==
$data["jadwal"]["hari"]
    ? "selected"
    : ""; ?>>
                                                    <?php echo $hr; ?>

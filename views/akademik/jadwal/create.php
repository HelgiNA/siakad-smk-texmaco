<?php
    // views/akademik/jadwal/create.php
    ob_start();
?>
                    ...
                    <form action="<?php echo BASE_URL;?>/jadwal/store" method="POST">
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                Tahun Ajaran: <strong><?php echo $data['tahun_aktif']['tahun'];?> - <?php echo $data['tahun_aktif']['semester'];?></strong>
                            </div>
                                        ...
                                        <select class="form-control" id="kelas_id" name="kelas_id" required>
                                            ...
                                            <?php foreach ($data['kelas'] as $kls): ?>
                                                <option value="<?php echo $kls['kelas_id'];?>">
                                                    ...
                                                    (Jurusan: <?php echo htmlspecialchars($kls['jurusan']);?>)
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
